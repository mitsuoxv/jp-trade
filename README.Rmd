...
# Export
# Download 2018-2023
export2023 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040022836&fileKind=1",
                          2023, n_area = 53)

export2022 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040009356&fileKind=1",
                          2022, n_area = 53)
...
# Import
# Download 2018-2023
import2023 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040022837&fileKind=1",
                            2023, n_area = 51)

import2022 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040009357&fileKind=1",
                            2022, n_area = 51)
