...
# Export
# Download 2018-2020
export2020 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000031966097&fileKind=1",
                          2020, n_area = 53) %>% 
...
# Import
# Download 2018-2020
import2020 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000031966098&fileKind=1",
                            2020, n_area = 51) %>% 
  mutate(`Exp or Imp` = as.character(`Exp or Imp`)) # only for January
