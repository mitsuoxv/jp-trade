...
# Export
# Download 2018-2021
export2021 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032060124&fileKind=1",
                          2021, n_area = 53)
...
export_df <- export_df %>% 
  bind_rows(export2017_1_3, export2017_4_12,
            export2018, export2019, export2020, export2021)


# Import
# Download 2018-2021
import2021 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032060125&fileKind=1",
                            2021, n_area = 51)
...
import_df <- import_df %>% 
  bind_rows(import2017_1_3, import2017_4_12,
            import2018, import2019, import2020, import2021)
...
usethis::use_data(trade, trade_year,
                  internal = TRUE,
                  overwrite = TRUE)
