...
yr_urls_ex_2018 <- tibble(
  ...
  "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040301355&fileKind=1") # 2025
)

yr_urls_im_2018 <- tibble(
  year = 2018:2025,
  urls = c(paste0(
    "https://www.e-stat.go.jp/stat-search/file-download?statInfId=",
    c(
  ...
  "https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040301356&fileKind=1") # 2025
)

# Export
# Download 2018-2025
export2018l <- map2(yr_urls_ex_2018$urls, yr_urls_ex_2018$year, read_url_year, n_area = 53)
...
export2009l <- map2(yr_urls_ex_2009$urls, yr_urls_ex_2009$year, read_url_year, n_area = 51)

# Import
# Download 2018-2025
import2018l <- map2(yr_urls_im_2018$urls, yr_urls_im_2018$year, read_url_year, n_area = 51)
...
import2009l <- map2(yr_urls_im_2009$urls, yr_urls_im_2009$year, read_url_year, n_area = 51)

# combine export and import
trade <- list_rbind(
  c(export2009l, list(export2017_1_3, export2017_4_12), export2018l, import2009l, list(import2017_1_3, import2017_4_12), import2018l)
)
