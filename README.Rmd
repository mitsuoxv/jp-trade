...
# Export
# Download 2018-2022
export2022 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032172220&fileKind=1",
                          2022, n_area = 53)

export2021 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032164836&fileKind=1",
                          2021, n_area = 53)
...
export_df <- export_df %>% 
  bind_rows(export2017_1_3, export2017_4_12,
            export2018, export2019, export2020, export2021, export2022)


# Import
# Download 2018-2022
import2022 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032172221&fileKind=1",
                            2022, n_area = 51)

import2021 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000032164837&fileKind=1",
                            2021, n_area = 51)
...
import_df <- import_df %>% 
  bind_rows(import2017_1_3, import2017_4_12,
            import2018, import2019, import2020, import2021, import2022)
