...
# Export
# Download 2018-2025
export2025 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040251145&fileKind=1",
                          2025, n_area = 53)

export2024 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040243890&fileKind=1",
                          2024, n_area = 53)

export2023 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040223718&fileKind=1",
                          2023, n_area = 53)
...
export_df <- export_df %>% 
  bind_rows(export2017_1_3, export2017_4_12,
            ...
            export2024, export2025)

# Import
# Download 2018-2025
import2025 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040251146&fileKind=1",
                            2025, n_area = 51)

import2024 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040243891&fileKind=1",
                            2024, n_area = 51)

import2023 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000040223719&fileKind=1",
                            2023, n_area = 51)
