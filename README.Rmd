...
# Export
# Download 2018-2019
export2019 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000031846385&fileKind=1",
                          2019, n_area = 53)
...
export_df <- export_df %>% 
  bind_rows(export2017_1_3, export2017_4_12, export2018, export2019)


# Import
# Download 2018-2019
import2019 <- read_url_year("https://www.e-stat.go.jp/stat-search/file-download?statInfId=000031846386&fileKind=1",
                            2019, n_area = 51)
...
import_df <- import_df %>% 
  bind_rows(import2017_1_3, import2017_4_12, import2018, import2019)
